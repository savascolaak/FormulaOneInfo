...
namespace FormulaOneInfo.Data.Migrations
{
    ...
    [Migration("20241124193651_TeamModified")]
            ...
            modelBuilder.Entity("FormulaOneInfo.Entities.Concrete.GrandPrix", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(2797),
                            GrandPrixDate = new DateTime(2024, 3, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(2798),
            ...
            modelBuilder.Entity("FormulaOneInfo.Entities.Concrete.Pilot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(3633),
                            DateOfBirth = new DateTime(1985, 1, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Lewis",
                            IsActive = true,
                            IsDeleted = false,
                            LastName = "Hamilton",
                            ModifiedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(3633),
            ...
            modelBuilder.Entity("FormulaOneInfo.Entities.Concrete.Result", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(5426),
                            GrandPrixId = 1,
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(5426),
                            Note = "Results",
                            Order = 7,
                            PilotId = 1,
                            Points = 6,
            ...
            modelBuilder.Entity("FormulaOneInfo.Entities.Concrete.Season", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(6801),
                            EndDate = new DateTime(2024, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(6801),
            ...
            modelBuilder.Entity("FormulaOneInfo.Entities.Concrete.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(7470),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedDate = new DateTime(2024, 11, 24, 22, 36, 51, 421, DateTimeKind.Local).AddTicks(7470),
